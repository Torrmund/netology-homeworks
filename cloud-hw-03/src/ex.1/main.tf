...
resource "yandex_kms_symmetric_key" "key" {
  name = var.kms_simmetric_key_name
  description = var.kms_simmetric_key_description
  default_algorithm = var.kms_simmetric_key_algorithm
  rotation_period = var.kms_simmetric_key_rotation_period
}
